...
const ThemeSwitcher = () => {
  return (
    <div className="flex mt-6 bg-white justify-center dark:bg-gray-900 rounded-3xl border border-gray-800 dark:border-white border-opacity-10 dark:border-opacity-10 border-b-0">
      <button
        type="button"
        ...
        className="flex items-center h-full pr-2 dark:bg-primary rounded-3xl flex justify-center align-center w-24 h-10 transition"
      >
        {moonIcon}
      </button>
      ...
      <button
        ...
        className="flex items-center h-full pr-2 bg-primary dark:bg-transparent rounded-3xl flex justify-center align-center w-24 h-10 transition"
      >
        {sunIcon}
      </button>
    </div>
